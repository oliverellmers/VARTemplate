...
{
    [CustomEditor(typeof(SOEventListener_Vector3))]
    public class SOEventListener_Vector3Editor : Editor
    {
        public override void OnInspectorGUI()
        {
            SOEventListener_Vector3 script = (SOEventListener_Vector3)target;
